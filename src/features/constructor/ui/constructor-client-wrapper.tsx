...
export function ConstructorClientWrapper() {
  ...
  if (site === null) {
    return (
      <main className="constructor-loading">
        ...
        <p>Не удалось открыть сайт. Вернитесь в личный кабинет и попробуйте снова.</p>
      </main>
    );
  }

  return <ConstructorClient initialData={site} initialTab={initialTab} />;
}
